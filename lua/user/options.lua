local options = {
  ...
  -- cmdheight = 0,                           -- wasn't perfect since no display of how many searched objects are there
  -- display_lastline = true
  -- cmdwinheight = 1,
...
-- vim.cmd [[set iskeyword+=-]] --this will also include - when selecting the word
